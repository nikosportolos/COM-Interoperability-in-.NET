...
namespace InterprocessCommunication
{
    public class WindowMessaging : NativeWindow, IDisposable
    {
        ...
        // Function which implements custom message handling. 
        // Either way, then pass Message Handling through to base handler (i.e MainForm)
        ...
        // Function to find WindowHandle of VB6 app
        // and send async message through.
        ...
        {
            // Creating Window based on globally known name, 
            // and create handle so we can start listening to Window Messages.
